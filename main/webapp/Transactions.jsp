    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Show Transactions</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="card">
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
              <h5 class="card-title">Account Transaction History</h5>

              <!-- Horizontal Form -->
              <form name=F1 onSubmit="return dil(this)" action="Transactions1.jsp">
               <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" id="inputText" name="from" >
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">To Date:</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" id="inputEmail" name="to">
                  </div>
                </div>
                <div class="row mb-3">
