...
<title>Deposit Amount - DreamZbank</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Credit Fund</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
if(status==true){
	...
	ResultSet rs1=dep.executeQuery();
