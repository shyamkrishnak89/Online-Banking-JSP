...
<head>
    ...
    <!-- Site Metas -->
    <title>DreamZBank - Signup/Login</title>
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                           <h2><span class="theme_color"></span>SignUp / Login</h2>    
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="full services_blog">
                        ...
                        <button class="cancelbtn"  style="width:auto;" onclick = "window.location.href='create.html';">Not a user? Then Signup!!!</button>
                    </div>
                </div>
