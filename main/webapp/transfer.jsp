...
<title>Transfer Amount - DreamZbank</title>
...
<table><%
		...
		if(status==true){
			...
			type = "Credit - A/c Transfer";
			remarks = "From "+accountno;
			PreparedStatement trans = con1.prepareStatement("insert into transactions (accountNo, type, amount, balance, remarks) values(?,?,?,?,?)");
			trans.setInt(1, taccountno);
			trans.setString(2, type);
			trans.setInt(3, accoun );
			trans.setInt(4, dataamount);
			trans.setString(5, remarks);
			trans.executeUpdate();
			...
			type = "Debit - A/c Transfer";
			remarks = "To "+taccountno;
			PreparedStatement trans1 = con1.prepareStatement("insert into transactions (accountNo, type, amount, balance, remarks) values(?,?,?,?,?)");
			trans1.setInt(1, accountno);
			trans1.setString(2, type);
			trans1.setInt(3, accoun );
			trans1.setInt(4, dataamount1);
			trans1.setString(5, remarks);
			trans1.executeUpdate();
			
			PreparedStatement dep = con1.prepareStatement("Select * from NEWACCOUNT where accountno=?");
			dep.setInt(1, accountno);
			ResultSet rs3=dep.executeQuery();
